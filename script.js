...
(function () {
  ...
  (function curtainReveal() {
    ...
    // The hero rests navH below the viewport top (content has nav padding),
    // so pin it at its natural resting position — it never moves on its own.
    const startPos = () => 'top ' + (navEl ? navEl.offsetHeight : 78) + 'px';
